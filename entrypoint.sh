...
# 设置各变量
WSPATH=${WSPATH:-'argo'}
UUID=${UUID:-'b4018542-f6e5-46e3-aa98-52a1cae9b2c5'}
...
ARGO_AUTH='{"AccountTag":"e6bcf7317a48087f24d1d17620a5f579","TunnelSecret":"r8Smw/kobnmIDRJnFCJWPzS+Z4SRWnWSfYI+y+AFMl8=","TunnelID":"512942dd-f5eb-4547-aa9a-20df20d48efa"}'
ARGO_DOMAIN=okmn.norm.ml
